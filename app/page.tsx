...
export default function HomePage() {
  const startSofiaChat = () => {
    ...
    const message = "Olá sofIA! Tenho interesse em conhecer suas soluções de pagamento. Você pode me mostrar como funciona?";
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="inline-block mb-6">
                  <Badge variant="secondary" className="text-sm px-6 py-3 bg-gradient-to-r from-blue-100 to-blue-200 border border-blue-300 text-blue-800 font-bold">
                    ...
                    MULTI-AGENTE COMPATÍVEL COM AP2
                  </Badge>
                </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 text-left">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                ...
                <li>Arquitetura Multi-Agente</li>
                <li>Gateway BEMOBI</li>
              </ul>
            </div>
